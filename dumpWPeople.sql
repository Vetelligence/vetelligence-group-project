...
1	phil	$2a$10$kueoHMeq2.557uxLxa658u9JJRX6M6.sTBi2iccQZ0FfvrDERjo5a	Minnesota	Minneapolis	veteran	Philip	Mitchel	philMitchel@philMitchel.com	651 555 5555
...
11	electricalMaintenance	$2a$10$at7MgAwsfFPgoTOhS6oXEuqXE.RryBWxxoCPtN37S5x0XQR2vPOWK	MO	Lee's Summit	employer	Sara	Walker	electricalMaintenance@electricalMaintenance.com	555 222 1111
12	lawyerjobs	$2a$10$Etfk33G2GYyrvgatYkWlfulOQdgUTvHSrfhR8O7T2rDl699gtfA..	MO	Independence	employer	Judy	Jones	lawyerJobs@lawyerJobs.com	555 888 0000
13	admin	$2a$10$fJ8o293V5oBe13mv0b0WzO5KWE7k.Bdxp0v6XqSM9RCsUzSe/qnMy	MO	Kansas City	admin	Joe	Snuffy	js@js.js	555 555 5555
\.
...
3	10	Sales Shop	pending
4	11	Electrical Maintenance	pending
5	12	Lawyer Jobs	pending
1	6	General Contractors 	approved
2	8	Software Engineer family	approved
\.
...
COPY public.jobs (id, job_name, employer_id, job_description, city, state, date_deleted) FROM stdin;
1	Roofer	6	Repairing or building roofs	Kansas City 	MO	\N
2	Construction Manager	6	Manage on-site crews	Kansas City 	MO	\N
4	Front end Dev I	8	React, Redux, Sagas	Minneapolis	MN	\N
5	Full Stack Dev I	8	Develop apps 	Minneapolis	MN	\N
3	Flooring	6	Lays flooring	Kansas City	MO	\N
\.
...
SELECT pg_catalog.setval('public.employer_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.job_skills_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.veterans_id_seq', 5, true);
